...
export function AgentPermissionModeButton({
  ...
  return (
    <div className="group/permission relative shrink-0">
      ...
      <div className="pointer-events-none absolute bottom-full right-0 z-[80] mb-2 w-56 translate-y-1 rounded-xl border border-white/60 bg-card/95 px-3 py-2 text-[11px] text-muted-foreground opacity-0 shadow-[0_14px_36px_rgba(64,55,38,0.16)] ring-1 ring-border/50 backdrop-blur-xl transition duration-150 group-hover/permission:translate-y-0 group-hover/permission:opacity-100 group-focus-within/permission:translate-y-0 group-focus-within/permission:opacity-100">
