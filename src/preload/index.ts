...
const api: BrevynAPI = {
  ...
  cloud: {
    ...
    syncConversationProvider: (input?: CloudSyncConversationProviderInput) => ipcRenderer.invoke(IPC_CHANNELS.cloudSyncConversationProvider, input),
    activateConversationProvider: (input: CloudActivateConversationProviderInput) => ipcRenderer.invoke(IPC_CHANNELS.cloudActivateConversationProvider, input),
    ...
    redeemCode: (input: CloudRedeemCodeInput) => ipcRenderer.invoke(IPC_CHANNELS.cloudRedeemCode, input),
