...
const api: BrevynAPI = {
  ...
  references: {
    list: (query?: ReferenceScopeQuery) => ipcRenderer.invoke(IPC_CHANNELS.referencesList, query),
    create: (input: ReferenceCreateInput) => ipcRenderer.invoke(IPC_CHANNELS.referencesCreate, input),
    update: (input: ReferenceUpdateInput) => ipcRenderer.invoke(IPC_CHANNELS.referencesUpdate, input),
    archive: (referenceId: string) => ipcRenderer.invoke(IPC_CHANNELS.referencesArchive, referenceId),
    delete: (referenceId: string) => ipcRenderer.invoke(IPC_CHANNELS.referencesDelete, referenceId),
    addScope: (input: ReferenceScopeInput) => ipcRenderer.invoke(IPC_CHANNELS.referencesAddScope, input),
    removeScope: (scopeId: string) => ipcRenderer.invoke(IPC_CHANNELS.referencesRemoveScope, scopeId),
    import: (input: ReferenceImportInput) => ipcRenderer.invoke(IPC_CHANNELS.referencesImport, input),
    export: (input: ReferenceExportInput) => ipcRenderer.invoke(IPC_CHANNELS.referencesExport, input),
  },
  git: {
