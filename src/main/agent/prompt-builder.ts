...
export class PromptBuilder {
  ...
  private buildBaseRules(): string {
    return [
      ...
      "",
      "## Workspace Memory",
      "- CLAUDE.md at the workspace cwd is durable workspace memory; read it when useful and update it only for reusable guidance.",
      "- The session memory directory is private working memory for this conversation. Use it sparingly for notes, todos, and plans.",
      "- Session memory files are not course evidence and must not be cited as source material.",
      "",
      "## Tool Strategy",
