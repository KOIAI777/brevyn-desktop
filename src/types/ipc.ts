export const IPC_CHANNELS = {
  ...
  referencesList: "brevyn:references:list",
  referencesCreate: "brevyn:references:create",
  referencesUpdate: "brevyn:references:update",
  referencesArchive: "brevyn:references:archive",
  referencesDelete: "brevyn:references:delete",
  referencesAddScope: "brevyn:references:add-scope",
  referencesRemoveScope: "brevyn:references:remove-scope",
  referencesImport: "brevyn:references:import",
  referencesExport: "brevyn:references:export",
